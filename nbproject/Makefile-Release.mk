...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/side_scroller.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/side_scroller ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/BulletManager.o: BulletManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BulletManager.o BulletManager.cpp
